...
K\"ahler manifolds, the Hodge decomposition and the Lefschetz theorems.
\item Part~\ref{part-algebraic-geometry}, \emph{Algebraic Geometry}: varieties,
schemes, coherent cohomology, GAGA, abelian varieties, algebraic cycles.
\item Part~\ref{part-hodge-theory}, \emph{Hodge Theory}: Hodge structures, the
Hodge conjecture, the evidence for it, its failed variants and the conjectures
around it.
\end{itemize}
...
The natural numbers include zero: $\NN = \{0, 1, 2, \ldots\}$. A real number $x$
is \emph{positive} if $x > 0$ and \emph{non-negative} if $x \geq 0$.
\end{notation}
