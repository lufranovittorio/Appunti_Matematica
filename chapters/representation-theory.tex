...
Show that every irreducible complex representation of a finite abelian group is one-dimensional, and that a
finite group is abelian if and only if all its irreducible complex representations are one-dimensional.
\end{exercise}
