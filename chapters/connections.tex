...
A section $s$ along a smooth curve $\gamma \colon [0, 1] \to M$ is \emph{parallel} if $\nabla_{\dot\gamma}s = 0$. \emph{Parallel transport} along $\gamma$ is the map $P_\gamma \colon E_{\gamma(0)} \to E_{\gamma(1)}$
