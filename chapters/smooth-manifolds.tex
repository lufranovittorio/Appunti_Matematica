...
$(r/x)\,\partial/\partial x$, a different vector. The formula $dr = \cos\theta\,dx + \sin\theta\,dy$ that one often meets is a different statement, about the differential
of the function $r$, a covector rather than a vector; the two are compared in Chapter~\ref{differential-forms}.
\end{example}
